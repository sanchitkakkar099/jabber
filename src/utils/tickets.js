...
export async function seedTickets() {
  ...
  lsWrite([
    { id: now-1, name:'Arjun Kumar',    email:'arjun.k@techconfasia.com', category:'Technical',       subject:'Stream drops after ~20 minutes',    message:'Hi, I\'ve been testing with OBS and my stream disconnects from Yadia after about 20 minutes. RTMP logs show a "connection reset" error. This happens on every attempt. Please help!', priority:'high',   status:'open',        notes:[], createdAt: new Date(now-1*day).toISOString(), updatedAt: new Date(now-1*day).toISOString() },
    ...
    { id: now-5, name:'Isabel Costa',   email:'isabel.c@mediacorp.br',    category:'General',          subject:'Can we white-label the viewer page?',message:'We are a media company and want to offer Yadia-powered translation under our own brand. Is white-labelling or iframe embedding of the viewer page possible on Pro?', priority:'medium', status:'open',        notes:[], createdAt: new Date(now-9*day).toISOString(), updatedAt: new Date(now-9*day).toISOString() },
  ])
