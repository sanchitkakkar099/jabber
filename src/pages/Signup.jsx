        ...
        <div className="auth-right-content">
          ...
          <div className="auth-features">
            <div className="auth-feature">
              ...
              <div className="auth-feature-text"><h4>Free Starter plan</h4><p>5 hours/month, 3 languages, 100 viewers. No credit card needed.</p></div>
            </div>
            <div className="auth-feature">
              <div className="auth-feature-icon"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="3" width="20" height="14" rx="2" ry="2"/><line x1="8" y1="21" x2="16" y2="21"/><line x1="12" y1="17" x2="12" y2="21"/></svg></div>
            ...
            <div className="auth-feature">
              ...
              <div className="auth-feature-text"><h4>Viewer app included</h4><p>Attendees pick their language. No app download required.</p></div>
            </div>
          </div>

          <div className="auth-stats">
            <div className="auth-stat"><div className="auth-stat-num">$0</div><div className="auth-stat-label">To start</div></div>
            <div className="auth-stat"><div className="auth-stat-num">10 min</div><div className="auth-stat-label">Setup time</div></div>
            <div className="auth-stat"><div className="auth-stat-num">24 hrs</div><div className="auth-stat-label">Onboarding</div></div>
          </div>

          <div className="amp-wrap">
            <div className="amp-header"><span className="amp-brand">Perfect for</span></div>
            <div style={{display:'flex',flexWrap:'wrap',gap:6,marginTop:4}}>
              {['Conferences','Town Halls','Worship Services','Sports Broadcasts','Concerts','Webinars','Government Sessions'].map(t => (
          ...
          <div className="auth-quote">
            <p>"We onboarded in 15 minutes and ran our first multilingual event the same day. Absolutely game-changing."</p>
