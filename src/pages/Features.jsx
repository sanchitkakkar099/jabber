...
const features = [
  ...
  { color:'fi-green', title:'Developer API', desc:'Fully documented REST and WebSocket APIs. Webhook support for stream events. SDKs for Web, iOS, and Android. Embed Yadia directly into your own event platform or app in minutes.' },
]
...
export default function Features() {
  ...
  function handleCTA() {
    ...
    track('lead_captured', { source: 'Features CTA', page: '/features' })
  ...
  return (
    <>
      <SEO
        ...
        description="Yadia's full feature set: AI speech transcription (<500ms), parallel translation into 10+ languages, neural voice synthesis, edge WebSocket delivery, auto scale to zero, and a full developer API."
        canonical="/features"
        schema={{
          '@context': 'https://schema.org',
          '@type': 'ItemList',
          name: 'Yadia Features',
          description: 'Complete list of Yadia real-time translation platform features',
          itemListElement: [
        ...
        <div className="container">
          <div className="tech-inner">
            <div className="tech-left reveal">
              ...
              <p className="tech-intro">Serverless by design — Yadia runs on purpose-built enterprise infrastructure optimised for ultra-low-latency audio processing, real-time translation, and global edge delivery.</p>
