  ...
  return (
    <div className="adm-login-bg">
      <div className={`adm-login-card${shake ? ' shake' : ''}`}>
        <img src="/logo.png" alt="Zabber" style={{ height:64, marginBottom:24, display:'block', margin:'0 auto 24px' }} />
        ...
        <p style={{ textAlign:'center', marginTop:20, fontSize:'0.78rem', color:'#94a3b8' }}>
          <Link to="/" style={{ color:'#6366f1' }}>← Back to Zabber</Link>
        </p>
      </div>
    </div>
  )
  ...
  return (
    <aside className="adm-sidebar">
      <div className="adm-sidebar-logo">
        <img src="/logo.png" alt="Zabber" style={{ height:36, filter:'invert(1)', mixBlendMode:'screen' }} />
    ...
    <div className="adm-section">
      <div className="adm-section-header">
        <div>
          ...
          <p className="adm-page-sub">Welcome back — here's what's happening with Zabber.</p>
        </div>
