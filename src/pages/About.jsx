  ...
  return (
    <>
      <SEO
        ...
        description="Zabber was built to make every live event accessible in any language. Learn about our mission, team values, and why we believe real-time AI translation changes global communication."
        canonical="/about"
        schema={{
          '@context': 'https://schema.org',
          '@type': 'AboutPage',
          name: 'About Zabber',
          description: 'Zabber is building infrastructure to make every live event accessible to everyone, everywhere, in their own language — instantly.',
      ...
      <section className="page-hero">
        <div className="container page-hero-inner">
          <div className="section-tag-wrap"><span className="section-tag">About Zabber</span></div>
        ...
        <div className="container">
          <div className="mission-inner">
            <div className="mission-text reveal">
              ...
              <p>We built Zabber to change that. Using the latest AI for transcription, translation, and voice synthesis, we deliver real-time multilingual access to any live stream — at a fraction of the cost of traditional solutions, with none of the infrastructure overhead.</p>
        ...
        <div className="container">
          ...
          <div className="values-grid">
            {[
              ...
              { icon:'🔓', title:'Accessible pricing', desc:'Language access shouldn\'t be a luxury. We price Zabber to be within reach for non-profits, educational institutions, and community organisations — not just enterprises.' },
              ...
              { icon:'🛠️', title:'Builders first', desc:'We build for the event organisers and developers who use Zabber every day. Our API is a first-class product, not an afterthought. Documentation is part of the feature.' },
