  ...
  return (
    <>
      <SEO
        ...
        description="Get in touch with the Zabber team for support, enterprise pricing, API partnerships, or press enquiries. We reply within one business day."
        canonical="/contact"
      />
        ...
        <div className="container">
          <div className="contact-inner">
            <div className="contact-info-col reveal">
              ...
              <p>Whether you're planning your first multilingual event or evaluating Zabber for enterprise deployment, we're happy to answer questions, offer a demo, or help you get set up.</p>
